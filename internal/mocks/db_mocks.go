...
// Source: slash10k/internal/db (interfaces: Database,Connection,Queries)
//
// Generated by this command:
//
//	mockgen -destination=../mocks/db_mocks.go -package=mock_db slash10k/internal/db Database,Connection,Queries
//
